     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label>Exam Time Limit <i class="text-primary">(in minutes)</i></label>
            <input type="number" step="1"class="form-control" name="timeLimit" required="" placeholder="60">
          </div>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="bdate" id="bdate" class="form-control" placeholder="Input  Matric Number" autocomplete="off" >
          </div>
          <div class="form-group">
            <label>Gender</label>
